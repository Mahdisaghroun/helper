...
import { getElevenSportDta, getElevenSportDtaItalia } from '../../api/api';
import { copy } from '../../utils/copy';

class ElevenItalia extends Component {
   ...
   async componentDidUpdate(previousProps, previousState) {
        if (previousState.tabId !== this.state.tabId) {
            ...
            let res = await getElevenSportDtaItalia(this.state.tabId)
    ...
    async componentDidMount() {
       ...
       // console.log(res.data)
        let channels = res.data.events
        console.log("hahahahah",channels)
       // this.setState({events:channels})
...
export default connect(mapStateToProps, { getStudents, setMessage, deleteStudent })(ElevenItalia);
