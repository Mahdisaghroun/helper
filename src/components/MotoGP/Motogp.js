...
import { getElevenSportDta, getMotoGP } from '../../api/api';
...
class Mediaset extends Component {
    ...
    async componentDidMount() {
        let response = await getMotoGP(this.props.nodeLinks?.motogp.key)
    ...
    render() {
        ...
        if (loading) {
            ...
            let studentsTable = this.state.events?.cdns?.map((itemData, i) => {
                let el = itemData.feeds

                return (
                    <tr key={itemData.id}>
                        <td >{itemData.label} </td>
                        <td >
                        <button className='btn btn-success btn-sm mr-1' onClick={() => copy(  el[0].protocols.hls.url)}><i class="fa fa-copy"></i></button>

                       </td>
                       <td >
                        <button className='btn btn-success btn-sm mr-1' onClick={() => copy(  el[1].protocols.hls.url)}><i class="fa fa-copy"></i></button>

                       </td>

                       <td >
                        <button className='btn btn-success btn-sm mr-1' onClick={() => copy(  el[2].protocols.hls.url)}><i class="fa fa-copy"></i></button>

                       </td>

                       <td >
                        <button className='btn btn-success btn-sm mr-1' onClick={() => copy(  el[3].protocols.hls.url)}><i class="fa fa-copy"></i></button>

                       </td>

                       <td >
                        <button className='btn btn-success btn-sm mr-1' onClick={() => copy(  el[4].protocols.hls.url)}><i class="fa fa-copy"></i></button>

                       </td>

                       <td >
                        <button className='btn btn-success btn-sm mr-1' onClick={() => copy(  el[5].protocols.hls.url)}><i class="fa fa-copy"></i></button>

                       </td>
                       <td >
                        <button className='btn btn-success btn-sm mr-1' onClick={() => copy(  el[6].protocols.hls.url)}><i class="fa fa-copy"></i></button>
