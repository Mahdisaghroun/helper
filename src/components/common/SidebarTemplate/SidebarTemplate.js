...
function SidebarTemplate(props) {
    ...
    <div className={classnames("d-flex", { toggled: toggled })} id="wrapper">
      ...
      <div className="bg-dark border-right" id="sidebar-wrapper">
        <div className="sidebar-heading text-center text-light ">
          ...
          />
          <h3>{props.admin.isAdmin ? "Admin" : user?.username}</h3>
        ...
        {(props.admin.isAdmin || user?.privillege?.indexOf("DASHBOARD") > -1) && <Link
            ...
            className={`list-group-item list-group-item-action bg-${
              currentPath == "/dashboard" ? "primary" : "dark"
            } text-light`}
          >
          ...
          <Link
            to="/schedule"
            className={`list-group-item list-group-item-action bg-${
              currentPath == "/schedule" ? "primary" : "dark"
            } text-light`}
          >
            <i class="fa fa-calendar" aria-hidden="true"></i>{" "}
          ...
          {(props.admin.isAdmin ||
            ...
            <Link
              to="/elevensport"
              className={`list-group-item list-group-item-action bg-${
                currentPath == "/elevensport" ? "primary" : "dark"
              } text-light`}
            >
          ...
          {(props.admin.isAdmin ||
            ...
            <Link
              ...
              className={`list-group-item list-group-item-action bg-${
                currentPath == "/elevensportitalia" ? "primary" : "dark"
              } text-light`}
            >
              <i className="fas fa-tv"></i>{" "}
          ...
          {(props.admin.isAdmin ||
            user?.privillege?.indexOf("DAZN IT") > -1) && (
            <Link
              to="/daznit"
              className={`list-group-item list-group-item-action bg-${
                currentPath == "/daznit" ? "primary" : "dark"
              } text-light`}
            >
              <i className="fas fa-tv"></i>{" "}
              {sectionNames && sectionNames[11] ? sectionNames[11] : " DAZN IT"}
            </Link>
          )}
          ...
          {(props.admin.isAdmin ||
            ...
            <Link
              to="/daznde"
              className={`list-group-item list-group-item-action bg-${
                currentPath == "/daznde" ? "primary" : "dark"
              } text-light`}
            >
              <i className="fas fa-tv"></i>{" "}
          ...
          {(props.admin.isAdmin ||
            ...
            <Link
              to="/daznes"
              className={`list-group-item list-group-item-action bg-${
                currentPath == "/daznes" ? "primary" : "dark"
              } text-light`}
            >
              <i className="fas fa-tv"></i>{" "}
          ...
          {(props.admin.isAdmin ||
            ...
            <Link
              to="/volleyball"
              className={`list-group-item list-group-item-action bg-${
                currentPath == "/volleyball" ? "primary" : "dark"
              } text-light`}
            >
              <i className="fas fa-tv"></i>{" "}
          ...
          {(props.admin.isAdmin ||
            ...
            <Link
              to="/discovery"
              className={`list-group-item list-group-item-action bg-${
                currentPath == "/discovery" ? "primary" : "dark"
              } text-light`}
            >
              <i className="fas fa-tv"></i>{" "}
          ...
          {(props.admin.isAdmin ||
            ...
            <Link
              to="/serieA"
              className={`list-group-item list-group-item-action bg-${
                currentPath == "/serieA" ? "primary" : "dark"
              } text-light`}
            >
              <i className="fas fa-tv"></i>{" "}
          ...
          {(props.admin.isAdmin ||
            ...
            <Link
              to="/mediaset"
              className={`list-group-item list-group-item-action bg-${
                currentPath == "/mediaset" ? "primary" : "dark"
              } text-light`}
            >
              <i className="fas fa-tv"></i>{" "}
          ...
          {(props.admin.isAdmin ||
            ...
            <Link
              to="/motogp"
              className={`list-group-item list-group-item-action bg-${
                currentPath == "/motogp" ? "primary" : "dark"
              } text-light`}
            >
              <i className="fas fa-tv"></i>{" "}
              {sectionNames && sectionNames[10]
 ...
 {(props.admin.isAdmin ||
            ...
            <Link
              to="/worldpadel"
              className={`list-group-item list-group-item-action bg-${
                currentPath == "/worldpadel" ? "primary" : "dark"
              } text-light`}
            >
              <i className="fas fa-tv"></i>{" "}
          ...
          {features?.map((el, i) => {
           ...
           return (
            hasView? <Link
              to={el.path}
              className={`list-group-item list-group-item-action bg-${
                currentPath === el.path ? "primary" : "dark"
              } text-light`}
            >
          ...
          {props.admin.isAdmin && (
            ...
            >
              ...
              <Link
                to="/staff"
                className={`list-group-item list-group-item-action bg-${
                  currentPath == "/staff" ? "primary" : "dark"
                } text-light`}
              >
              ...
              <Link
                to="/features"
                className={`list-group-item list-group-item-action bg-${
                  currentPath == "/features" ? "primary" : "dark"
                } text-light`}
              >
              ...
              <Link
                to="/config"
                className={`list-group-item list-group-item-action bg-${
                  currentPath == "/config" ? "primary" : "dark"
                } text-light`}
              >
              ...
              <Link
                to="/rename"
                className={`list-group-item list-group-item-action bg-${
                  currentPath == "/rename" ? "primary" : "dark"
                } text-light`}
              >
      ...
      <div id="page-content-wrapper">
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav ml-auto mt-2 mt-lg-0">
              <li className="nav-item">
                <div className="nav-link logout">TEMP.V 1.4.7</div>
              </li>
            ...
            <ul className="navbar-nav ml-auto mt-2 mt-lg-0">
              <li className="nav-item">
                <div className="nav-link logout" onClick={onLogoutHandler}>
                  Logout
                </div>
              </li>
            </ul>
        ...
        <div className="container-fluid sidebar-template">{props.children}</div>
      </div>
